...
public final class PreviewViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<String> {
  @Override
  public String get() {
    return provide();
  }
  ...
  public static String provide() {
    return Preconditions.checkNotNullFromProvides(PreviewViewModel_HiltModules.KeyModule.provide());
  }
